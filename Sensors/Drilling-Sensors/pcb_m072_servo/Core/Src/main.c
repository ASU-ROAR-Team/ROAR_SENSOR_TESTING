...
#define MIN_PULSE_VALUE     250  // 0.5ms pulse for 0 degrees
#define MAX_PULSE_VALUE     1250 // 2.5ms pulse for 180 degrees
#define MID_PULSE_VALUE     750  // 1.5ms pulse for 90 degrees
